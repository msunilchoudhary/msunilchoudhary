...
import LogoFade from "../assets/images/msc-logo.png";

function HomeHero() {
  return (
    <section className="w-full bg-blue-950 text-white">
      <div className="max-w-7xl mx-auto px-4 container relative z-20 pt-32">
        <div className="relative z-20 grid lg:grid-cols-12 grid-cols-1 lg:justify-items-normal justify-items-center gap-20 pb-16">
          <div className="lg:col-span-7 col-span-1">
            <div className="flex flex-col lg:items-start items-center gap-8">
              <h1 className="lg:text-start text-center max-w-xl text-6xl font-bold leading-20">
                I'm Sunil<br />
              ...
              <div className="flex item-center gap-5 mt-3">
                <Link to="/">
                  <button className="px-12 py-3 font-medium text-white border rounded-lg border-text-amber-600 bg-amber-600 hover:bg-transparent hover:text-amber-600 hover:cursor-pointer duration-300">
                    Download CV
                  </button>
                </Link>
                <Link to="/">
                  <button className="px-12 py-3 font-medium text-primary border rounded-lg border-primary bg-transparent hover:bg-blue-600 hover:text-white hover:cursor-pointer duration-300">
                    Contact me
                  </button>
                </Link>
              </div>
