  ...
  return (
    <section className='w-full mt-20 bg-white'>
        <div className="container mx-auto max-w-7xl px-4">
            <div className="grid md:grid-cols-12 items-center gap-7 mt-25 ">
            <div className="md:col-span-6">
              <img
                alt="logo"
                width="375"
                height="0"
                src="https://themewagon.github.io/venus-nextjs/images/work-progress/progress-work.png"
              />
            </div>
            <div className="md:col-span-6 aos-init aos-animate">
